      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{ $t('upload_file.import_file') }}</h5>
          </div>
          <div class="modal-body">
            <form class="batch_create" id="batch_create" enctype="multipart/form-data" :action="action" accept-charset="UTF-8" method="post">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ $t('upload_file.close') }}</button>
            <button type="button" class="btn btn-danger btn-delete" data-dismiss="modal" @click='submitForm'>{{ $t('upload_file.upload') }}</button>
          </div>
        </div>
      </div>
    </div>
