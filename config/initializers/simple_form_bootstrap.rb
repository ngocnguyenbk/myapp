...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: "form-check mr-2", item_label_class: "form-check-label", tag: "fieldset", class: "form-group d-flex", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    b.use :html5
    b.optional :readonly
